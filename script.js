        ...
        video.addEventListener(
            ...
            var loopID = setInterval(function () {
                ...
                model.detect(video).then(function (predictions) {
                    var dogCount = predictions.filter(prediction => prediction.class === 'dog').length;
                    var humanCount = predictions.filter(prediction => prediction.class === 'person').length;
                    document.getElementById("dog-count").innerText =  dogCount;
